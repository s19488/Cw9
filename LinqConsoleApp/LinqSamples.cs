...
namespace LinqConsoleApp
{
    public class LinqSamples
    {
        ...
        */
        ...
        {
            var res = Emps.Where(emp => emp.Job == "Frontend programmer" && emp.Salary > 1000).OrderByDescending(x => x.Job);

            foreach (var element in res)
            {
                global::System.Console.WriteLine(element);
            }
        }
        ...
        {
            var res = Emps.Where(emp => emp.Job == "Frontend programmer").FirstOrDefault();
            global::System.Console.WriteLine(res);
        }
        ...
        {
            var res = Emps.SelectMany(A => Depts, (B, C) => new { EmpName = B.Ename, EmpJob = B.Job, C });
            foreach (var element in res)
            {
                global::System.Console.WriteLine(element);
            }
